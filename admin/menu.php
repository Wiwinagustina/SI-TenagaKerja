          ...
          <ul class="sidebar-menu">
            ...
            <li>
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="input_tenaga_kerja.php"><i class="fa fa-plus-square"></i> Input Tenaga Kerja</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="input_jenis_tenaga_kerja.php"><i class="fa fa-tasks"></i> Input Jenis Tenaga Kerja</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="input-admin.php"><i class="fa fa-user-plus"></i> Input Admin</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="aktivitas.php">
                <i class="fa fa-industry"></i> <span>aktivitas</span>
