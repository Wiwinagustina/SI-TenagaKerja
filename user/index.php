           ...
           <?php $tampil=mysqli_query($koneksi, "select * from tenaga_kerja order by id desc");
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="tenaga_kerja.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="jenis_tenaga_kerja.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
